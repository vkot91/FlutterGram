...
class _ProfileState extends State<Profile> {
  ...
  handleUnfollowUser(){
    ...
    //Remove follower
    followersRef.document(widget.profileId).collection('followers').document(
        currentUserId).get().then((doc){
          if(doc.exists){
  ...
  handleFollowUser() {
    ...
    //Make auth user follower of another user( update collection)
    followersRef.document(widget.profileId).collection('userFollowers').document(
